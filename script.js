    ...
    if (ip) {
        ...
        fetch(finalUrl, { mode: 'no-cors' })
            .then(() => {
                ...
                document.body.innerHTML = `<div style="background-color: #f05d5d; width: 100%; height: 100vh; display: flex; justify-content: center; align-items: center;"><h1 style="color: #ffffff; font-size: 24px; text-align: center;">Спасибо, за голос! Данные сохранены.</h1></div>`;
            })
